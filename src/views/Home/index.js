...
const Home = () => {
  ...
  return (
    <div className='flex h-screen overflow-hidden'>
      <div className='w-2/5'>
        <img className="w-full h-full object-cover" src={Chairs} alt="Movie Chairs" />
      </div>
      <div className="w-3/5 flex justify-center items-center flex-col px-10">
        ...
        <input 
          className="bg-special-gray font-lato w-full my-3 h-9 p-1 border-1 focus:outline-none focus:ring-2 focus:ring-gray-500 rounded"
          value={search}
